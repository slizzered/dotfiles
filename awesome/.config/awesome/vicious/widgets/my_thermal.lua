...
local function worker(format, warg)
    ...
    local zone = { -- Known temperature data sources
        ...
        ["core1"] = {"/sys/devices/platform/",  file = "temp1_input",div = 1000},
        ["core2"] = {"/sys/devices/platform/",  file = "temp2_input",div = 1000},
        ["core3"] = {"/sys/devices/platform/",  file = "temp3_input",div = 1000},
        ["core4"] = {"/sys/devices/platform/",  file = "temp4_input",div = 1000},
        ["core5"] = {"/sys/devices/platform/",  file = "temp5_input",div = 1000},

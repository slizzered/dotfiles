...
--  * (c) 2011, Carlchristian E. <slizzered@gmx.de>
---------------------------------------------------
...
local function worker(format)
    ...
    -- added to collect all connections together...
    nets["all"] = {}
    nets["all"][1] = 0
    nets["all"][2] = 0
    helpers.uformat(args, "all down", 0, unit)
    helpers.uformat(args, "all up",   0, unit)
    ...
    for line in io.lines("/proc/net/dev") do
	    ...
	    -- added to collect all connections together...
	    nets["all"][1] = recv + nets["all"][1]
	    nets["all"][2] = send + nets["all"][2]
        end
    end
    return args
end
